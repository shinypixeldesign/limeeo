  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-slate-900 text-white">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge && (
                <span className="text-xs px-1.5 py-0.5 rounded-md bg-indigo-500/20 text-indigo-300 font-medium">
                  {item.badge}
                </span>
              )}
            </Link>
      ...
      <div className="px-3 py-4 border-t border-slate-800">
        <Link
          href="/upgrade"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-amber-400 hover:bg-slate-800 hover:text-amber-300 transition-colors mb-1"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
