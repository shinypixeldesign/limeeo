...
export async function POST() {
  try {
    ...
    const context = `Ești un asistent AI pentru freelanceri, integrat în Freelio CRM. Astăzi este ${now.toLocaleDateString('ro-RO', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}.
