        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {project.description ? (
            <div className="bg-white rounded-[24px] p-8 shadow-lg shadow-black/5">
              <h3 className="text-xs font-bold text-gray-900 mb-5 uppercase tracking-wide">Descriere proiect</h3>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line text-sm">
                {project.description}
              </p>
            </div>
          ) : (
            <div className="bg-white rounded-[24px] p-8 shadow-lg shadow-black/5 border-2 border-dashed border-gray-100">
